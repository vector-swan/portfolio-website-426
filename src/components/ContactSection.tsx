  ...
  <div className="absolute inset-0 pointer-events-none overflow-hidden">
    <div
      ...
      style={{
        ...
        top: "-15%", left: "-10%",
        background: "radial-gradient(circle, hsla(340,72%,72%,0.12) 0%, transparent 70%)",
        filter: "blur(80px)",
    ...
    <div
      ...
      style={{
        ...
        bottom: "0%", right: "-5%",
        background: "radial-gradient(circle, hsla(340,65%,60%,0.1) 0%, transparent 70%)",
        filter: "blur(70px)",
    ...
    <div
      ...
      style={{
        ...
        top: "20%", right: "10%",
        background: "radial-gradient(circle, hsla(220,60%,55%,0.1) 0%, transparent 70%)",
        filter: "blur(70px)",
        animation: "mesh-drift-3 12s ease-in-out infinite",
      }}
    />
    <div
      className="absolute rounded-full"
      style={{
        ...
        bottom: "10%", left: "25%",
        background: "radial-gradient(circle, hsla(340,72%,72%,0.08) 0%, transparent 70%)",
        filter: "blur(60px)",
        animation: "mesh-drift-4 15s ease-in-out infinite",
      }}
    />
  </div>
);
...
const ContactSection = () => {
  ...
  return (
    <section
      ...
      style={{ background: "#FAFAFA", backgroundImage: "none" }}
      ref={ref}
    >
      <SoftMeshBg />
      <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        ...
        >
          ...
          <div className="flex flex-row gap-6 items-center">
            ...
            <a href="https://www.linkedin.com/in/miadonnell/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors text-sm font-medium">
              LinkedIn
            </a>
